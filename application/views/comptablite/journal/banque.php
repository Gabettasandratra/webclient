    ...
    <div class="modal-dialog" style="margin-top: 80px;" role="document">
      <div class="modal-content"> 
        <div class="modal-header">
          <h5 class="modal-title" id="titre">Journal Banque</h5>
        </div>
             ...
             <form id="myForm" action="" method="post">
                ...
                <div class="col-12">
                    ...
                    <div class="form-group row">
                      ...
                      <input type="hidden" name="numCmpt" id="numCmpt" value="2">
                    </div>
...
$('#modalAdd').modal('show');
  ...
  $('#change').click(function(){
     $('#modalAdd').modal('show');
     $('#dialog').attr('style','display:none;');//container
  });
...
$('#btnAff').click(function(){
    ...
    if(dates == ''){
     ...
     $('#textAff').html('Journal banque jusqu\'au date :  '+d); 
...
function getDonne(data){
      $.ajax({
            type:'ajax',
            method: "post",
            url: '<?php echo base_url();?>index.php/getJournal',
            dataType:'json',
            data: data,
            async: false,
