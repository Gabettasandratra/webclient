    ...
    <div class="modal-dialog" style="margin-top: 80px;" role="document">
      <div class="modal-content"> 
        <div class="modal-header">
          <h5 class="modal-title" id="titre">Journal caisse</h5>
        </div>
             ...
             <form id="myForm" action="" method="post">
                ...
                <div class="col-12">
                    ...
                    <div class="form-group row">
                      ...
                      <input type="hidden" name="numCmpt" id="numCmpt" value="1">
                    </div>
...
$('#btnAff').click(function(){
    ...
    if(dates == ''){
     ...
     $('#textAff').html('Journal caisse jusqu\'au date :  '+d); 
