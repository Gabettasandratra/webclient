				 ...
				 <div class="row"> 
				 	...
				 	<div class="col-6">
			           ...
			           <!--  <legend style="text-align: left;font-size: 18px !important;" class="col-sm-12">Compte budgétaire</legend>
			            ...
			            <div class="form-group row">
				             <label for="codeBudget" class="col-sm-4 col-form-label">Budgét: </label>
				           <div class="col-sm-6">
    ...
    success:function(response){
		...
		if (response.success) {
       		...
       		if(c.length == null){
	              ...
	              '<td>' + c.nom + '</td>' +
	              '<td>' +
	              '<a href="javascript:;" id="selectCod" class="btn btn-success btn-sm item-codeAn" data="'+ c.id+'">Selectionner</a>' +
	              '</td>' +       
	              '</tr>';
       		}else{
                  ...
                  '<td>' + c[i].nom + '</td>' +
                  '<td>' +
                  '<a href="javascript:;" id="selectCod" class="btn btn-success btn-sm item-codeAn" data="'+ c[i].id+'">Selectionner</a>' +
                  '</td>' +       
                  '</tr>';
    			}
       		}
