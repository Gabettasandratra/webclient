                         ...
                         <div class="form-group row">    
                          ...
                          <div class="form-group row">    
                           <label for="cmptEquilibre" class="col-sm-4">Compte d'équilibre:</label>
                            <div class="col-sm-6">
                              <input type="hidden" value="<?php echo $config->resultat->caisse->tkey ?>" name="compte2" id="compte2">
                              <input type="hidden" value="<?php echo $config->resultat->caisse->numCpt ?>" name="numCptEq" id="numCptEq">
                              <input type="hidden" value="<?php echo $config->resultat->caisse->label ?>" name="labCptEq" id="labCptEq">
                              <input type="text" style="background-color:yellow;" value="<?php echo $config->resultat->caisse->numCpt ?> | <?php echo $config->resultat->caisse->label ?>"
