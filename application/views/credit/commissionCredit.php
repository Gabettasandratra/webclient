...
<div class="right_col" role="main">
 <div class="col-md-12 col-sm-12" style="margin-top:2%;">
  <div class="x_panel tile ">
    <div class="x_title">
      <h2>Paiement Commission avant approbation</h2>
...
<!--   <div class="card-header col-8 place">
    <h5 align="center" class="titre">Paiement Commission avant approbation</h5>
  </div>
  <br>
  <br> -->
...
$(function(){ 
  ...
  function afficheCredit(){
      ...
      $.ajax({
        type:'ajax',
        method:"get",
        url:"<?php echo base_url();?>index.php/chargeCommAvant",
        dataType:"json",
        data:{mc: '1'} ,
        async: false,
        success:function(response){
            if(response){
                ...
                c.length+' crédit en attente de commission';
                $('#legende').html(led);*/
        ...
        error: function(){
          alert('Accun crédit peut être payer la commission avant approbation');
    	...
    	$.ajax({
            ...
            success: function(response) {
                ...
                if (response.success) {
                    ...
                    $('#modalAdd').dialog('close');
                    $('#myForm')[0].reset();
                    $('.alert-success').html('Payemment commission enregistré avec succes!').fadeIn().delay(5000).fadeOut('slow');
                    afficheCredit();
                }
                else {
                    alert('Erreur');
