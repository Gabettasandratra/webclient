<!-- <div class="container" style="display:none">
	...
	<div class="card-header col-8 place">
		<h5 align="center" class="titre">Rapport comptes dépôts à termes supprimés</h5>
	</div>
	<br>
	<hr>  -->
<div class="right_col" role="main">
 <div class="col-md-12 col-sm-12" style="margin-top:2%;">
  <div class="x_panel tile " id="pre" style="display:none">
    <div class="x_title">
      <h2>Rapport comptes dépôts à termes supprimés</h2>
...
<div id="modalAdd" title="Rapport dépôts à terme supprimés" style="margin-top: 2%">
...
$(function(){
	...
	function getRapport(data){
		$.ajax({
	      type:'ajax',
	      method:"post",
	      url:'<?php echo base_url();?>index.php/getRapportDATSupprimer',
	      dataType:'json',
	      data: data,
	      async: false,
