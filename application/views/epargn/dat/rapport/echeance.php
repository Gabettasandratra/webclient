<!-- <div class="container" style="display:none">
	...
	<div class="card-header col-8 place">
		<h5 align="center" class="titre">Rapport échéances dépôts à termes</h5>
	</div>
	<br>
	<hr>  -->
<div class="right_col" role="main">
 <div class="col-md-12 col-sm-12" style="margin-top:2%;">
  <div class="x_panel tile " id="pre" style="display:none">
    <div class="x_title">
      <h2>Rapport échéances dépôts à termes</h2>
...
<div id="modalAdd" title="Rapport échéances dépôts à terme" style="margin-top: 2%">
...
$(function(){
	...
	function getRapport(data){
		$.ajax({
	      type:'ajax',
	      method:"post",
	      url:'<?php echo base_url();?>index.php/getRapportEcheanceDAT',
	      dataType:'json',
	      data: data,
	      async: false,
	        success: function(response) {
             ...
             var html;
           	 ...
           	 if(c.length == null){
	          	  ...
	          	  totalMontant +=parseFloat(c.total);
	              ...
	              '</tr>';
	          	  ...
	          	  totalMontant +=parseFloat(c[i].total);
	              ...
	              '<td>' + c[i].dateDepot + '</td>' +
	              '<td>' + c[i].montant + '</td>' +
	              '<td>' + c[i].dateRetrait + '</td>' +
	              '<td>' + c[i].taxe + '</td>' +
	              '<td>' + c[i].penalite + '</td>' +
	              '<td>' + c[i].totalIntRetrait + '</td>' +
	              '<td>' + c[i].total + '</td>' +
	              '</tr>';
