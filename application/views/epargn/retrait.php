        ...
        <form id="myForm" action="" method="post">           
          <div class="col-12" style="margin-top:10px;margin-bottom:10px;">                
           <div class="control-group row"> 
            ...
            <input type="hidden" name="transaction" value="RE" id="transaction">
  ...
  <div class="control-group row">
    ...
    <div class="col-4">  
      ...
      <div class="form-group row">                                        
          ...
          <div class=" col-sm-6">
            <input type="text" name="description" value="Retrait" class="form-control form-control-sm col-12" id="description">
          </div>
      </div>
...
//CHOIX PAYEMENT
   ...
   $('#mobile').click(function() {
    ...
    //$('#btn-depot').attr('disabled', true);

     $('#choixTransaction').change(function() {
        
        var str = "";
        var d = new String('depot');
        var r = new String('retrait');
       
        $( "#choixTransaction option:selected" ).each(function() {
          str += $( this ).attr('value');
        });
        ...
        if(d == str){
          $('input[name="trans"]').val('Dépôt');
          $('input[name="transaction"]').val('DE');                                 
        }
        else if(r == str){          
          $('input[name="trans"]').val('Rétrait');
          $('input[name="transaction"]').val('RE');    
        }else{
          $('input[name="trans"]').val('Pas de transaction');
          $('input[name="transaction"]').val('i');   
        ...
        success: function(response) {
            ...
            $('#trAvant').attr('style','display: none;');
             $.notify({            
              ...
              $('input[name=description]').val('Retrait');
